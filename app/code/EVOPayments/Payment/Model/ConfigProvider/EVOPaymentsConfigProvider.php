...
namespace EVOPayments\Payment\Model\ConfigProvider;

use Magento\Checkout\Model\ConfigProviderInterface;
use Magento\Payment\Helper\Data as PaymentHelper;

class EVOPaymentsConfigProvider implements ConfigProviderInterface
{
    ...
    public function __construct(
        ...
        \EVOPayments\Payment\Helper\Helper $helper
    )
    {
